...
//Returns true if union of found thrackles covers the K_n graph
...
/*
    Prints a partition of integer stored in a.
    Used by integer_partition program.
*/
...
/*
    Generates the integer partitions of an integer
    but these partitions are of a maximal size 'max_size'
    and there is no element e such that e> max_val.
    USed by integer_partition program.
*/
