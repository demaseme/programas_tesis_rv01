...
/*
    Finds the next thrackle (stores it in thrackle vector).
*/
...
/*
    Like find_next_thrackle but doesnt need the desired_size of the thrackle
    it finds the next thrackle based on the current thrackle!
*/
